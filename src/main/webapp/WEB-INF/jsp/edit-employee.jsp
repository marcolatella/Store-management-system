...
<div class="container">
    ...
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            <form:form method="post" action="/store/${storeId}/update-employee" modelAttribute="empToEdit" >
                <div class="form-row">
                    <div class="form-group col-3">
                        <label>Employee Id</label>
                        <form:input class="form-control" placeholder="Id" path="id" readonly="true"></form:input>
                    </div>
                    <div class="form-group col-3">
                        <label>Name</label>
